      ...
      <div className="max-w-6xl mx-auto px-4">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <div className="leading-tight">
                ...
                <div className="text-[9px] font-medium tracking-wider uppercase text-gray-400">SENIOR SOLUTIONS</div>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="flex gap-3 mb-4">
              ...
              <a
                href="#"
                aria-label="Facebook"
                className="w-8 h-8 rounded flex items-center justify-center bg-gray-700 hover:bg-[#8B1A4A] transition-colors"
              >
            ...
            <div className="flex flex-col gap-2 text-sm text-gray-400">
              <a href="tel:+12024026339" className="hover:text-white transition-colors">
                +1 (402) 426-0339
              </a>
              <a href="mailto:jennifer@premier-senior.com" className="hover:text-white transition-colors break-all">
                jennifer@premier-senior.com
              </a>
            </div>
            {/* BBB Badge */}
            <div className="mt-4 inline-flex items-center gap-2 border border-gray-600 rounded px-3 py-2">
              <div
                className="w-8 h-8 rounded flex items-center justify-center text-white font-black text-xs"
        ...
        <div className="border-t border-gray-700 pt-6 text-center">
          <p className="text-gray-500 text-xs">
            ...
            <span className="text-gray-400">Screen Digital</span>
          </p>
        </div>
      </div>
    </footer>
